...
const floatingElements = [
  { Icon: BookOpen, x: '28%', y: '23%', size: 48, delay: 0, duration: 4, color: 'text-primary' },
  { Icon: Pencil, x: '43%', y: '65%', size: 36, delay: 1, duration: 4.5, color: 'text-primary/70' },
  { Icon: GraduationCap, x: '90%', y: '15%', size: 56, delay: 0.5, duration: 5, color: 'text-accent' },
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <motion.div initial={{
          ...
          <motion.div initial={{
            ...
            <span className="text-sm font-medium text-muted-foreground">Sangli's Premier English Academy</span>
          </motion.div>
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-6 -translate-x-11">
        ...
        >
          <div className="relative w-full aspect-square max-w-xl mx-auto">
            ...
            <motion.div animate={{
              ...
              <img alt="English teacher ready to help you learn" className="w-full h-full object-contain drop-shadow-2xl scale-110" src="/teacher2.png" />
            </motion.div>

            {/* Glow effect behind – soft, low saturation orange */}
            {/* <div className="absolute inset-0 bg-gradient-to-br from-accent/15 to-accent/5 blur-3xl -z-10 scale-60" /> */}
